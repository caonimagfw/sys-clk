...
void AppProfileFrame::addFreqs(brls::List* list, SysClkProfile profile)
{
    ...
    cpuListItem->getValueSelectedEvent()->subscribe([this, profile](int result) {
        ...
        this->profiles.mhzMap[profile][SysClkModule_CPU] = result == 0 ? result : sysclk_g_freq_table_cpu_hz[result];
    ...
    gpuListItem->getValueSelectedEvent()->subscribe([this, profile](int result) {
        this->onProfileChanged();
        this->profiles.mhzMap[profile][SysClkModule_GPU] = result == 0 ? result : sysclk_g_freq_table_gpu_hz[result];
    ...
    memListItem->getValueSelectedEvent()->subscribe([this, profile](int result) {
        this->onProfileChanged();
        this->profiles.mhzMap[profile][SysClkModule_MEM] = result == 0 ? result : sysclk_g_freq_table_mem_hz[result];
